    ...
    <div className="flex justify-center items-center min-h-screen">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="p-6  shadow-lg rounded-2xl flex flex-col items-center text-center">
          ...
          <button className="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-lg" onClick={()=>{window.location.href="/app/add-course"}}>Add Course</button>
        </div>

        {/* View All Quizzes Card */}
        <div className="p-6 shadow-lg rounded-2xl flex flex-col items-center text-center">
          <Eye size={48} className="text-green-500 mb-4" />
          <h2 className="text-xl font-semibold mb-2">View All Courses</h2>
          <p className="text-gray-600 mb-4">Browse and manage existing quizzes.</p>
          <button className="bg-green-500 hover:bg-green-600 text-white px-4 py-2 rounded-lg" onClick={()=>{window.location.href="/app/all-quizzes"}}>View Courses</button>
        </div>
      </div>
    </div>
  );
