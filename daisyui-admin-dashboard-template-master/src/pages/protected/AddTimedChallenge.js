...
const CreateTimedChallenge = () => {
  ...
  const handleSubmitChallenge = () => {
    const challengeData = {
      ...
      timeLimit: parseInt(timeLimit), // in minutes
      questions,
    };

    console.log("Submitting Challenge:", challengeData);

    // Send to backend here via axios.post(...)
    alert("Challenge Created!");
  };

  return (
    <div className="max-w-4xl mx-auto p-6 bg-white rounded-lg shadow-md mt-10">
      <h1 className="text-2xl font-bold mb-6 text-center text-blue-900">Create Timed Challenge</h1>
      ...
      <div className="mb-6 border p-4 rounded-md bg-gray-50">
        <h2 className="text-lg font-semibold mb-2 text-blue-800">Add Question</h2>
